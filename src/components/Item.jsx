  ...
  return (
    ...
    >
      <div className="bg-slate-100 rounded-full h-14 w-14 text-center flex items-center justify-center">
        <span className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-800 text-xl font-semibold">
          {number}
        </span>
      </div>
      ...
      <p className="text-slate-500 text-xl w-[30rem]">{description}</p>
    </motion.div>
  );
}
